...
public class MyPanel extends JPanel implements KeyListener{
	...
	public boolean[] player2Moving= {false,false};
	...
	public void move() {
		...
		//____________________PLAYER 2 MOVE__________________________
		
		if(player2Moving[0] &&  yPlayer2>0) {
			yPlayer2-=playersSpeed;
		}else if(player2Moving[1] && yPlayer2<(HEIGHT-playersHeight)) {
			yPlayer2+=playersSpeed;
		}
	...
	public void keyPressed(KeyEvent e) {
		switch(e.getKeyCode()) {
			case KeyEvent.VK_UP:
				player2Moving[0]=true;
				break;
			case KeyEvent.VK_DOWN:
				player2Moving[1]=true;
				break;
		}
	...
	public void keyReleased(KeyEvent e) {
		switch(e.getKeyCode()) {
			...
			case KeyEvent.VK_UP:
				player2Moving[0]=false;
				break;
			case KeyEvent.VK_DOWN:
				player2Moving[1]=false;
				break;
		}
